            ...
            <div className="row">
              <div className="col-lg-12">
                <nav className="navbar navbar-expand-lg navbar-dark">
                  ...
                  {     data?.basicInfo?.funnel_status === 'Deactivated' ? <></> :

                    <div className="collapse navbar-collapse" id="collapsibleNavbar">
                      <ul className="navbar-nav ml-auto" id="myNavbar">
                        <li className="nav-item">
                          <NavLink
                            to="/advisee/dashboard"
                            className={(isActive) =>
                        ...
                        {data?.basicInfo?.funnel_status === 'Onboarding' ? (
                          <>
                            <li className="nav-item">
                              <a
                                href="#"
                                ...
                                onClick={() =>
                                  toasterAlert(
                                    'error',
                                    'Please complete onboarding before you can meet with an Advisors!'
                                  )
                                }
                              // className={(isActive) =>
                              //   `nav-link ${isActive ? 'active' : ''}`
                        ...
                        <li className="nav-item">
                          <a className='nav-link' target="_blank" href='https://join.slack.com/t/candooradvisees/shared_invite/zt-1gjwq8ylz-~ZARBvvR2Q5RDPFts6~MLg'>
                            Community
                          </a>
                        ...
                        <li className="nav-item dropdown profiledrop">
                          ...
                          >
                            <img
                              ...
                              src={
                                !!data?.basicInfo?.profile_goal
                                  ? process.env.REACT_APP_API_URL + `/${data?.basicInfo?.profile_goal}`
                                  : myprofile
                              }
                              className="img-fluid"
                              alt=""
                          ...
                          <div className="dropdown-menu">
                            <a
                              onClick={(e) =>
                                history.push('/advisee/adviseeProfile')
                              }
                            ...
                            <a
                              className="dropdown-item"
                              href="#"
                              onClick={(e) => history.push('/advisee/setting')}
                            >
                              <svg
                                width="16"
                                height="16"
