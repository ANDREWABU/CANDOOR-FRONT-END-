...
class UpdateMeetingOutcome extends React.Component {
    ...
    getMeetingData = async () => {
        ...
        if (response.data) {
	        ...
	        if (this.state.meeting_data?.meeting_data?.meetingoutcome) {
						window.location.href = '/advisor/finalize-meeting/'+this.state.meetingid;
	        }
        }
    }
    ...
    handleOutcomeChange = (event) => {
        ...
        let finalized = 0;
        if(value == "advisornoshow" || value == "adviseenoshow") {
	        finalized = 1;
	      }
        this.setState({
		        advisor_meetingfinalized: finalized,
...
//        console.log('meetingoutcome: ' + this.state.meetingoutcome);
				this.submitstring = '/api/advisor-meeting-outcome?meetingId=' + this.state.meetingid + '&meetingoutcome=' + this.state.meetingoutcome;
//        console.log('submitstring: ' + this.submitstring);
        let outcomeresponse = await ApiRequest.postRequest(this.submitstring, this.state);//${meetingId}');
        if (outcomeresponse) {
          console.log(outcomeresponse);
	        if (outcomeresponse.status == 200) {
						window.location.href = '/advisor/finalize-meeting/'+this.state.meetingid;
          } else {
			        toasterAlert("warning", "Oops. Something went wrong. Try again or contact us.");
                            ...
                            <div className="col-md-12">
                                <div className="request-viewed-card">
                                    ...
                                    <div className="request-group">
                                        ...
                                        <form>
                                            <div className="outcome">
                                                <label>
                                                    <input
                                                        id="meetingoutcomeradio1"
                                                        type="radio"
                                                        name="meetingoutcomeradio"
                                                        value="meetingoccurred"
                                                ...
                                                <label >
                                                    ...
                                                    />
                                                     ...
                                                     No, Advisee did not attend this meeting
                                                </label>
                                                <label >
                                                    <input
                                                        id="meetingoutcomeradio3"
                                                        type="radio"
                                                        name="meetingoutcomeradio"
                                                        value="advisornoshow"
                                                        onChange={this.handleOutcomeChange}
                                    ...
                                    <div className="request-submit">
																			<input type="hidden" name="meetingoutcome" value={this.state.meetingoutcome} />
                                        <a
                                        ><button
                                        		id="submitme"
