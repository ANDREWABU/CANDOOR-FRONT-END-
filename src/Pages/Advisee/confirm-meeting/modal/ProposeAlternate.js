...
async function sendPostRequest(formData) {
  try {
    ...
    if (
      ...
      document.getElementById('closeBtnAdviseePA')?.click();
...
function ProposeAlternate({ id, service, advisee_time_zone }) {
  ...
  function onSubmit(data) {
    ...
    formData.append('proposed_timezone', advisee_time_zone);
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Your Availability in <span className='timezone-bright-red'>{advisee_time_zone}</span></label>
                <p>
                  Provide at least 3 dates and time intervals that you are
                  available, in your own timezone. The more timei intervals you
