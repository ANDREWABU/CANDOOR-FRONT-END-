    ...
    getMeetingData = async () => {
        ...
        if (response.data) {
	        ...
	        if (this.state.meeting_data?.meeting_data?.meetingoutcome) {
						window.location.href = '/advisee/finalize-meeting/'+this.state.meetingid;
	        }
        }
    }
...
//        console.log('meetingoutcome: ' + this.state.meetingoutcome);
				this.submitstring = '/api/advisee-meeting-outcome?meetingId=' + this.state.meetingid + '&meetingoutcome=' + this.state.meetingoutcome;
