...
class YourProfile extends React.Component {
    ...
    changeStep(position = 'next') {
        if (position == 'back') {
            history.push('/advisee/signupwizard/yourJourney')
        }
    ...
    submit = async () => {
        let { imageErrors, tagsErrors, about_youErrors, headline_errors } = '';
        ...
        if (this.state.headline == '') {
            headline_errors = 'Please enter your headline'
        }
        ...
        this.setState(prevState => ({
            errors: {
                ...
                headline: headline_errors,
            }
        }))


        if (imageErrors || tagsErrors || about_youErrors || headline_errors) {
            return true;
        }
        ...
        try {
            ...
            if (
                ...
                history.push('/advisee/signupwizard/welcome')
        ...
        return (
            ...
            <div className={`row mar-width-0 mt-80 NewStepThird__Wrapper`}>
                <div className="col-md-12 text-center wizardHeading">
                    ...
                    <p>
                        At Candoor, we’re all about candid conversations. Your profile helps Advisors get to know the human being behind your name!
                    </p>
                </div>
                <div className='row'>
                ...
                <div className='row'>
                    ...
                    <div className="col-md-12 form-group margintop ">

                        <div className='form-group'>
                            <div className='careerlabel'>
                                <b>Headline </b>(How you'd introduce yourself to a potential Advisor. When in doubt, use your LinkedIn headline.)

                            </div>
                            <input type="text" className="form-control" name="headline" onChange={this.onChangeState} value={this.state.headline} placeholder='Computer Science Major at Iowa State University' />
                ...
                <div className='row'>
                    <div className='col-md-12'>
                        <div className='form-group'>
                            ...
                            <div className='careerlabel'>
                                <b> About You </b> (your bio, written in the first-person. Tell Advisors who you are, what you’re passionate about and how you became who you are today!)
                            </div>
                            <>
                                <textarea
                                    name='about_you'
                                    ...
                                    placeholder={'I’m an Iowa State student, athlete and adventure lover who is passionate about technology. I have had past internships at Boeing and Uber as a software engineer. After completing my computer science degree, I hope to become a technical program manager (TPM) because I love solving problems for users at scale. I’m the first person in my family to have attended college, and I’m excited to expand my network on Candoor!'}
                                ></textarea>
